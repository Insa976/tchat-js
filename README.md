...
- Télécharger le projet <a href="#">ici</a>
...
- Choissiez un fichier. Allez dans votre espace de travail, dans bdd selectionnez le fichier <strong>"tchat.sql"</strong>. Et ensuite éxécuter
Nous avons configuré notre base de données maintenant nous allons la connection avec PHP ett MySQL
